...
class Controler(ControlerBase):
    ...
    def budget_periode_donnee(self,compte,date_debut,date_fin):
        return(fc.budget_periode_donnee(compte,date_debut,date_fin))

    # Fonction pour l'onglet bourse
    def read_csv_bourse(self,compte,nom):
        fc.read_csv_bourse(compte,nom)
        self.refreshAll()

    def get_CAC_40_names(self):
        return fc.CAC_40_names

    def historique_bourse(self, date_debut, date_fin):
        return fc.bourse_date_donnee(self.compte.bourse.date, self.compte.bourse.prix,self.compte.bourse.volume, date_debut, date_fin)

    def get_invest_budget(self,compte):
        invest=None
    ...
    def bourse_budget_restant(self,compte,date_debut,date_fin):
        return(fc.bourse_budget_restant(compte,date_debut,date_fin))
